...
namespace LessonEnglish
{
    public partial class test5 : Form
    {
        ...
        void start()
        {
            ...
            try
            {
                ReadFile = new System.IO.StreamReader(System.IO.Directory.GetCurrentDirectory() + @"\t5.txt", Encoding);
        ...
        private void CalculateAndSaveResults()
        {
            try
            {
                string queryString = "UPDATE Result SET result_test_5 = @UserResult " +
