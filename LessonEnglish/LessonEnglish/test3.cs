...
namespace LessonEnglish
{
    public partial class test3 : Form
    {
        ...
        void start()
        {
            ...
            try
            {
                ReadFile = new System.IO.StreamReader(System.IO.Directory.GetCurrentDirectory() + @"\t3.txt", Encoding);
        ...
        private void CalculateAndSaveResults()
        {
            try
            {
                string queryString = "UPDATE Result SET result_test_3 = @UserResult " +
