...
namespace LessonEnglish
{
    public partial class test4 : Form
    {
        ...
        void start()
        {
            ...
            try
            {
                ReadFile = new System.IO.StreamReader(System.IO.Directory.GetCurrentDirectory() + @"\t4.txt", Encoding);
        ...
        private void CalculateAndSaveResults()
        {
            try
            {
                string queryString = "UPDATE Result SET result_test_4 = @UserResult " +
